...
java -cp '../../../lib/BiNoM.jar;../../../lib/VDAOEngine.jar'  fr.curie.BiNoM.pathways.MaBoSS.MaBoSSProbTrajFile -makeinter -table ginsimout_norm.dat -phenotype CellCycleArrest -phenotype_short CCA -out ginsimout >epistasis_summary.txt
...
java -Xmx4000M -cp '../../../lib/BiNoM.jar;../../../lib/VDAOEngine.jar'  fr.curie.BiNoM.pathways.MaBoSS.MaBoSSProbTrajFile -makeinter -table ginsimout_norm.dat -phenotype Migration/Metastasis/Invasion/EMT -phenotype_short Metastasis2 -out ginsimout >>epistasis_summary.txt
java -Xmx4000M -cp '../../../lib/BiNoM.jar;../../../lib/VDAOEngine.jar'  fr.curie.BiNoM.pathways.MaBoSS.MaBoSSProbTrajFile -makeinter -table ginsimout_norm.dat -phenotype Migration/Metastasis/Invasion/EMT/CellCycleArrest -phenotype_short Metastasis3 -out ginsimout >>epistasis_summary.txt
